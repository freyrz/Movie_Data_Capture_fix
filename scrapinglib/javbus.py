...
class Javbus(Parser):
    ...
    cookies = 'existmag=mag; PHPSESSID=vmfffh4e4498gq0if130i1q4n1; 4fJN_2132_saltkey=OsjqSDuu; 4fJN_2132_lastvisit=1697599340; 4fJN_2132_sid=g6xJHT; 4fJN_2132_lastact=1697604360%09misc.php%09seccode; 4fJN_2132_seccodecSsINHHn=19886.a5ae86165179e877e5'
    extraheader = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.46'}
    def search(self, number):
        ...
        try:
            if self.specifiedUrl:
                ...
                return result
            try:
                self.detailurl = 'https://www.javbus.com/search/' + number
